...
-----------------------------------------------
@Time       :   2024/5/14
@Description:   模型部署系统学习：利用PyTorch创建超分辨率模型SRCNN(动态，放大倍数作为另一个输入)，并把模型部署到ONNX Runtime上
""" ""
import torch 
...
# custom define a PyTorch operator
class NewInterpolate(torch.autograd.Function): 
 
    # 建立torch算子与onnx算子的映射关系
    @staticmethod 
    def symbolic(g, input: torch.Tensor, scales: torch.Tensor): 
        return g.op("Resize", 
                    input, 
                    g.op("Constant", 
