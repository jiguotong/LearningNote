...
python data_processing/create_pc_off.py -res 30 -num_points 300
```

## 3.训练流程
python train.py -std_dev 0.1 0.01 -res 32 -m ShapeNetPoints -batch_size 6


## 4.推理流程
python generate.py -std_dev 0.1 0.01 -res 32 -m ShapeNetPoints -checkpoint 10 -batch_points 400000
